...
set_prompt() {
    ...
    # Create segments with Arch logo integrated in username segment
...
# To use this file, add these lines to your ~/.bashrc:
# source ~/.config/bash-prompt-cyberpunk.sh
# 
# If you want to manually run neofetch, just type 'neofetch' directly.
# But it will NOT run automatically on terminal startup anymore.